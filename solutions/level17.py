...
class ReverseComputer:
    ...
    def __init__(self, lines: list[str]):
        ...
        self.operations = list(map(int, lines[4].split(" ")[-1].split(",")))
        self.instruction_pointer = len(self.operations)
        self.output = self.operations.copy()
...
def parse_input_file_1() -> Computer:
    return Computer(read_input_file(17))


def parse_input_file_2() -> ReverseComputer:
    return ReverseComputer(read_input_file(17))


def level17_1() -> str:
    computer = parse_input_file_1()
    computer.boot()
    return computer.get_output()


def level17_2() -> str:
    computer = parse_input_file_2()
    return computer.calc_initial_A()


if __name__ == '__main__':
    timer = RunTimer()
    print(f"Output: {level17_1()}")
    print(f"Register A: {level17_2()}")
    timer.print()


def test_level17():
    assert level17_1() == "4,6,3,5,6,3,5,2,1,0"
    assert level17_2() == 117440
